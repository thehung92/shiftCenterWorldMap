...
The goal of shiftCenterWorldMap is to vizualize a fish-eyed world (robinson projection) with the center of the map on your area of interest. The edge of region is also densify with st_segmentize.
