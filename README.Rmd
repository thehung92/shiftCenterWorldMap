...
The goal of shiftCenterWorldMap is to vizualize a fish-eyed world (robinson projection) with the center of the map on your area of interest

![rotate-world](man/figures/animation-world.gif)

## Installation

You can install the development version of shiftCenterWorldMap from [GitHub](https://github.com/) with:
...
Create world map in robinson project with the center at lon:lat=100:0 and plot with ggplot
